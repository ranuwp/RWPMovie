...
public class MovieContract {
    ...
    public static final String AUTHORITY = "id.ranuwp.greetink.rwpmovie.moviecontentprovider";
    ...
    public static final class MovieTable implements BaseColumns{
        ...
        public static final Uri CONTENT_URI_WITH_ID = CONTENT_URI.buildUpon().appendPath("/#").build();
